...
import { toolSchema, ImageType } from './constant'
import { useCreateTool } from './logic'
import SetImages from '@/components/parts/Modal/setImages'

type ToolFormData = z.infer<typeof toolSchema>

/* eslint-disable @typescript-eslint/no-explicit-any */
const ToolCreate = ({ toolCategories, materials, toolImages }: any) => {
    ...
    const { handleCreateRequest } = useCreateTool()
    ...
    const handleImageSelect = (imageIds: number[]) => {
        const selectedImages = toolImages.filter((image: any) => imageIds.includes(image.id))
